module CrystalMC::Network::Protocol
  class ServerLoginPacket < Packet
    ...
    property seed : Int64 # Add this line
    ...
    def initialize(@entity_id : Int32 = 0, @username : String = "", @seed : Int64 = 0_i64, @level_type : String = "default",
    ...
    def read(io : IO)
      ...
      @seed = read_long(io) # Add this line
    ...
    def write(io : IO)
      # Write entity_id, username, seed, dimension in the correct format
      write_int(io, @entity_id)
      write_string(io, @username)
      write_long(io, @seed) # This line was causing the error - now @seed is defined
    ...
    def clone : Packet
      ServerLoginPacket.new(@entity_id, @username, @seed, @level_type, @game_mode, @dimension,
